        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserReporterId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Reports_Users_UserReporterId",
            ...
            migrationBuilder.CreateTable(
                name: "UserLikesComments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: true),
                    UserCommentPostId = table.Column<int>(type: "int", nullable: true),
                    LikeTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Unlike = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLikesComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserLikesComments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_UserLikesComments_userCommentPosts_UserCommentPostId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_UserReporterId",
                table: "Reports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLikesComments_UserCommentPostId",
                table: "UserLikesComments",
                column: "UserCommentPostId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLikesComments_UserId",
                table: "UserLikesComments",
                column: "UserId");
